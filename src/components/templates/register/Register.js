                ...
                <div className="p-5 rounded-3 bg-body shadow-sm">
                  ...
                  >
                    ...
                    <div className="mb-4">
                      ...
                      />
                      <div className="invalid-feedback">
                        لطفاً رمز عبور تکرار را وارد کنید.
                      </div>
                    </div>
                    <div className="mb-4">
                      <div className="form-check mb-4">
                        ...
                        <label className="form-check-label" htmlFor="remember">
                          <a href="terms.html">شرایط و ضوابط</a> را می پذیرم
                        </label>
                      </div>
                  ...
                  <div className="mt-3">
                    ...
                    <div className="text-center mb-4">
                      <a
                        className="btn btn-social btn-facebook text-white mb-3 mb-xl-0 me-3"
                        href="#"
                      >
                      ...
                      <a
                        className="btn btn-social btn-twitter text-white mb-3 mb-xl-0"
                        href="#"
                      >
