...
function Navbar() {
  ...
  return (
    <>
      <header>
        {/* Navbar */}
        <nav className="main-nav navbar navbar-expand-lg hover-navbar fixed-top navbar-light-dark bg-body">
          <div className="container">
            <a className="navbar-brand main-logo" href="#">
              {/* <span class="h2 text-white fw-bold mt-2">OneKit</span> */}
              <img
                className="logo-dark"
                src="src/img-min/logo/logo.png"
                alt="LOGO"
              />
            </a>
            {/* navbar toggler */}
            ...
            <div className="collapse navbar-collapse" id="navbarTogglerDemo">
              <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <div className="row g-0">
                      <div className="col-12 col-md-6">
                        <div className="dropdown-md-area">
                          <p className="dropdown-md-title">شرکتی</p>
                          <a
                          ...
                          >
                            ...
                            <div className="drop-text">
                              <p className="fw-medium">نمایندگی</p>
                            </div>
                          </a>
                          <a
                            className="dropdown-item d-flex"
                          ...
                          >
                            ...
                            <div className="drop-text">
                              <p className="fw-medium">نمونه کارها</p>
                            </div>
                          </a>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 bg-light-dark">
                        <div className="dropdown-md-area">
                          <p className="dropdown-md-title">سایر موارد</p>
                          <a
                            className="dropdown-item d-flex"
                            href="index-default.html"
                          >
                            <div className="drop-icon bg-primary text-light rounded-3">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="drop-text">
                              <p className="fw-medium">پیش فرض</p>
                            </div>
                          </a>
                          <a
                            className="dropdown-item d-flex"
                          ...
                          >
                            ...
                            <div className="drop-text">
                              <p className="fw-medium">برنامه همراه</p>
                            </div>
                          </a>
                          <a
                            className="dropdown-item d-flex"
                            href="index-desktop.html"
                          >
                            <div className="drop-icon bg-primary text-light rounded-3">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="drop-text">
                              <p className="fw-medium">برنامه دسک تاپ</p>
                            </div>
                          </a>
                          <a
                            className="dropdown-item d-flex"
                          ...
                          >
                            ...
                            <div className="drop-text">
                              <p className="fw-medium">
                                رویداد{" "}
                                <span className="badge small bg-success ms-2">
                                  جدید
                                </span>
                              </p>
                            </div>
                      ...
                      <div className="col-12 border-top text-center">
                        <div className="p-3 small">
                          صفحات آماده برای استفاده های مختلف ایجاد شده است.
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row g-0">
                      <div className="col-lg-4">
                        ...
                        <div
                          ...
                          style={{
                            backgroundImage:
                              'url("src/img-min/bg/bg-business.jpg")',
                          }}
                        >
                          {/* background overlay */}
                          <div className="overlay bg-gradient-primary opacity-90 z-index-n1" />
                          {/* banner content */}
                          <div className="header-banner-content">
                            <div className="mb-4 px-lg-4">
                              <h3 className="h4 text-light">بخش های مختلف</h3>
                              <p className="text-light">
                                طرح های متفاوت برای پروژه ها.
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <li className="nav-item dropdown">
                  ...
                  <div
                    className="dropdown-menu dropdown-menu-md dropdown-menu-lg-center p-4"
                    aria-labelledby="navbarmd"
                  >
                    <div className="list-group list-group-flush">
                      <a
                        className="list-group-item dropdown-item bg-tansparent d-flex align-item-center"
                        href="docs/user-documents/document.html"
                      >
                        {/* Icon */}
                        ...
                        <div className="ms-4 align-self-center">
                          <h6 className="text-uppercase mb-1">آموزش کلی</h6>
                          <p className="text-muted mb-0">راهنمای کامل</p>
                        </div>
                      </a>
                      <a
                        className="list-group-item dropdown-item bg-tansparent d-flex align-item-center"
                        href="docs/user-documents/plugins.html"
                      >
                        {/* Icon */}
                        <div className="align-self-center text-primary">
                          <svg
                ...
                <li className="nav-item">
                  <a className="nav-link" href="docs/svg-img/scribble.html">
                    خطوط و منحنی ها
                  </a>
                </li>
              </ul>
