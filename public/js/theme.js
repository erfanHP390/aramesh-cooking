(function () {
  ...
  const sub_dropdown_js = function () {
    ...
    const yaghout_submenu = function yaghout_submenu() {
      var yaghout_toggle = document.querySelectorAll(".dropdown-menu a.dropdown-toggle");
      var _loop = function _loop(i) {
        ...
        window.addEventListener("mouseup", function (event) {
          if (event.target != yaghout_toggle[i].nextElementSibling && event.target.parentNode != yaghout_toggle[i].nextElementSibling && event.target.classList.contains("dropdown-toggle") != true) {
